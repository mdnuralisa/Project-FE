...
<section class="bg-gray-50 dark:bg-gray-900">
    <div class="flex flex-col items-center justify-center bg-white rounded-lg shadow dark:border    dark:bg-gray-800 dark:border-gray-700 ">
      ...
      <div class="mx-auto max-w-screen-sm text-center ">
          ...
          <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">Add new categories based on your home-space.</p>
          </div>
      </div>
