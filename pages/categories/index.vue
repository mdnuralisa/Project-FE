        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                ...
                <div class="grid gap-8 lg:grid-cols-4 flex flex-row justify-items-center">
                    <div v-for="category in categories" class="flex flex-col items-center justify-center p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
